...
function asSupplier(row: any): SupplierRecord {
  return {
    id: String(row.id),
    name: row.name,
    phone: row.phone,
...
/** Shared add/edit supplier modal (Suppliers page + purchase quick actions). */
export function SupplierFormModal({ open, editing, onCancel, onSaved }: Props) {
