...
export const LazyPages = {
  ...
  Taxes: lazy(() => import('@/renderer/pages/setup/Taxes').then((m) => ({ default: m.Taxes }))),
...
export const AppRoutes: IAppRoutes[] = [
  ...
  { path: App_Routes.SETUP_TAXES, component: LazyPages.Taxes, roles: [Roles.COMPANY_OWNER, Roles.BRANCH_ADMIN] },
